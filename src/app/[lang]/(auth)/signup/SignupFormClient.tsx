            ...
            >
              ...
              <form onSubmit={handleSubmit} className="w-full space-y-4">
                ...
                <div
                  ...
                  className={`relative cursor-pointer rounded-2xl border p-5 transition-all duration-300 ${formData.role === 'advertiser'
                ...
                <div
                  ...
                  className={`relative cursor-pointer rounded-2xl border p-5 transition-all duration-300 ${formData.role === 'vendor'
                      ? 'border-orange-500 bg-orange-50/50 dark:bg-orange-500/10'
                      : 'border-gray-200 dark:border-zinc-800 hover:border-gray-300 dark:hover:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-900/50'
                    }`}
                >
