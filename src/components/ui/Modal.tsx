                ...
                <div className="flex items-center gap-3">
                   {type === 'danger' && (
                      <div className="w-10 h-10 rounded-full bg-[#fef2f2] dark:bg-red-500/10 text-[#ef4444] dark:text-red-400 border border-transparent dark:border-red-500/20 flex items-center justify-center shrink-0">
                        <WarningTriangle width={16} height={16} strokeWidth={2} />
                      </div>
                   )}
                   <h3 className="text-[17px] font-bold text-[#0f172a] dark:text-zinc-100">{title}</h3>
                 </div>
                 <button onClick={onClose} aria-label="Close modal" className="w-8 h-8 flex items-center justify-center rounded-lg text-[#94a3b8] dark:text-zinc-500 hover:text-[#475569] dark:hover:text-zinc-300 hover:bg-[#f1f5f9] dark:hover:bg-zinc-800 transition-all duration-200 ease-out hover:-translate-y-0.5 active:scale-[0.98] active:translate-y-0">
